...
public class BeanUtilTest {
	...
	public static class Create {
		...
		public void 単一オブジェクトの場合() throws Exception {
			...
			// Exercise
			DummyCreateTestClass actual = BeanUtil.create(DummyCreateTestClass.class, fieldValue);
		...
		public void 複数オブジェクトの場合() throws Exception {
			...
			List<Map<String, Object>> fieldValues = new ExtArrayList<Map<String, Object>>()
					.addThis(fieldValue).addThis(fieldValue).addThis(fieldValue);
			
			// Exercise
			List<DummyCreateTestClass> actual = BeanUtil.creates(DummyCreateTestClass.class, fieldValues);
