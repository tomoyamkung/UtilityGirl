...
public class DoubleUtilTest {
	...
	public static class IsInRange {
		...
		public void Nullの場合() throws Exception {
			...
			// Exercise
			// Verify
			assertThat(DoubleUtil.isInRange(null, MIN_VALUE, MAX_VALUE),
					is(false));
		}
		...
		public void ブランクの場合() throws Exception {
			...
			// Exercise
			// Verify
			assertThat(DoubleUtil.isInRange("", MIN_VALUE, MAX_VALUE),
					is(false));
		}
		...
		public void 範囲内_最小値と同じ() throws Exception {
			...
			// Exercise
			// Verify
			assertThat(DoubleUtil.isInRange(MIN_VALUE.toString(), MIN_VALUE,
					MAX_VALUE), is(true));
		}
		...
		public void 範囲外_最小値より1つ小さい値() throws Exception {
			...
			// Exercise
			// Verify
			assertThat(DoubleUtil.isInRange("123.44", MIN_VALUE, MAX_VALUE),
					is(false));
		}
		...
		public void 範囲内_最大値と同じ() throws Exception {
			...
			// Exercise
			// Verify
			assertThat(DoubleUtil.isInRange(MAX_VALUE.toString(), MIN_VALUE,
					MAX_VALUE), is(true));
		}
		...
		public void 範囲外_最大値より1つ大きい値() throws Exception {
			...
			// Exercise
			// Verify
			assertThat(DoubleUtil.isInRange("150.02", MIN_VALUE, MAX_VALUE),
					is(false));
		}
	}
